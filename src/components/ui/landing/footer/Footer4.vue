      ...
      <v-row>
        ...
        <v-col cols="12" md="4">
          ...
          <div class="d-flex mb-2">
            ...
            <a href="#" class="text-decoration-none secondary--text text--lighten-2">+962053824488</a>
          </div>
          <div class="d-flex mb-2">
            <v-icon color="secondary lighten-1" class="mr-2">mdi-email-outline</v-icon>
            <a href="#" class="text-decoration-none secondary--text text--lighten-2">sales@diazone.fr</a>
          </div>
        </v-col>
         <v-col cols="12" md="4">
         </v-col>
